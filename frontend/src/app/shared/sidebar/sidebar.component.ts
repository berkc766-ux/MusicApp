    ...
    <div class="h-full flex flex-col bg-black pt-6 pb-28 text-neutral-400 overflow-hidden">
        ...
        <ul class="space-y-1">
          ...
          <li>
            <a routerLink="/admin" routerLinkActive="bg-neutral-800 text-white"
              class="flex items-center gap-4 px-3 py-2.5 rounded-md transition-colors hover:text-white font-semibold text-sm">
              <svg viewBox="0 0 24 24" class="h-6 w-6 fill-current flex-shrink-0">
                <path d="M12 15.5c-1.9 0-3.5-1.6-3.5-3.5S10.1 8.5 12 8.5s3.5 1.6 3.5 3.5-1.6 3.5-3.5 3.5zm7.4-3c.1-.3.1-.6.1-1s0-.6-.1-1l2.2-1.7c.2-.2.3-.4.2-.6l-2.1-3.6c-.1-.2-.4-.3-.6-.2l-2.6 1c-.5-.4-1.1-.7-1.7-1l-.4-2.7C14.3 2.2 14.1 2 13.9 2h-4.2c-.3 0-.5.2-.5.4L8.8 5.1c-.6.3-1.2.6-1.7 1l-2.6-1c-.2-.1-.5 0-.6.2L1.8 8.9c-.1.2-.1.4.2.6l2.2 1.7c-.1.3-.1.6-.1 1s0 .6.1 1l-2.2 1.7c-.2.2-.3.4-.2.6l2.1 3.6c.1.2.4.3.6.2l2.6-1c.5.4 1.1.7 1.7 1l.4 2.7c.1.2.3.4.5.4h4.2c.3 0 .5-.2.5-.4l.4-2.7c.6-.3 1.2-.6 1.7-1l2.6 1c.2.1.5 0 .6-.2l2.1-3.6c.1-.2.1-.4-.2-.6l-2.2-1.7z"/>
              </svg>
              Admin Panel
            </a>
          </li>
      ...
      <div class="flex-1 overflow-y-auto px-3 scrollbar-thin">
        ...
        <ul class="space-y-0.5 mt-1">
          ...
          <li *ngIf="playlists.length === 0" class="px-3 py-2 text-xs text-neutral-600 italic">
            No playlists yet
          </li>
        </ul>
      </div>
